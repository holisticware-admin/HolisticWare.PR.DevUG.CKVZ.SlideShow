...
namespace HolisticWare.SlideShow.EXE.Models
{
	public partial class Images : List<Image>
	{
		...
		public Images()
		{
			string directoryOfImage = HttpContext.Current.Server.MapPath(dir);
		...
		{
			string imagerep = HttpContext.Current.Server.MapPath(dir);
		...
		{
			string directory_images = HttpContext.Current.Server.MapPath(dir);
