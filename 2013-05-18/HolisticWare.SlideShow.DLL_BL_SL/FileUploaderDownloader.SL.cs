		...
		public void UploadFile(string url, string filename)
		{
			...
			try
			{
				...
				else
				{
					...
					Messages[0] = "The file selected exceeds the size limit for uploads.";
					Messages[1] = "File Size";
				}
			}
			catch (Exception ex)
			{
				...
				Messages[0] = ex.Message.ToString();
				Messages[1] = "Upload Error";
			}
